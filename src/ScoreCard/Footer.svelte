...
<footer class="grid grid-cols-1 lg:grid-cols-2 lg:gap-4">
  <button
    class="reset p-3 text-xl font-semibold lg:px-16 lg:py-4 lg:text-lg lg:font-normal"
    on:click={resetQuiz}>Reset Quiz<svg
      viewBox="0 0 32 40"
      ...
      <path
        d="M16 8V0L6 10l10 10v-8c6.63 0 12 5.37 12 12s-5.37 12-12 12S4 30.63 4 24H0c0 8.84 7.16 16 16 16s16-7.16 16-16S24.84 8 16 8z" /></svg></button>

  <button
    class="download py-3 text-xl font-semibold lg:px-16 lg:py-3 lg:w-full lg:text-lg lg:font-normal text-center"
    href="#download"
    on:click={downloadCSV}>Download Results
